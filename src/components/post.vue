<template>
    <article class="post post-list">
        <div class="post-entry">
            <div class="feature">
                <router-link :to="`/article?id=${post.id}`" target="_blank">
                    <img :src="post.cover"/>
                </router-link>
            </div>
            ...
            <div class="p-time">
                ...
                {{post.created_at | parseTime}}
                <!-- <i v-if="post.isHot" class="iconfont iconfire" style="margin-left: 5px;color: #ff6d6d;"></i> -->
            </div>
            <!-- <p class="summary">{{post.content_html}}</p> -->
            <!-- 截取描述 -->
            <p class="summary" v-html="post.content_html">
            </p>
            ...
            <footer class="entry-footer">
                ...
                <div class="post-more">
                    <div style="display:inline;">
                        <el-tag class="article-tags" effect="dark" size="mini" v-for="item in post.tags" :key="item">
                            {{item}}
                        </el-tag>
                    </div>
                    <router-link :to="`/article?id=${post.id}`" target="_blank">
                ...
                <!-- <div class="info-meta">
                    ...
                    <div class="views">
                        <span><i class="iconfont iconeyes"></i>{{post.click_num}} 热度</span>
                    </div>
                </div> -->
            </footer>
        </div>
