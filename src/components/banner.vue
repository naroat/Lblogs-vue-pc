            ...
            <template v-if="isHome">
                ...
                <div class="focusinfo">
                    ...
                    <div class="header-tou">
                        ...
                        <!-- <router-link to="/"><img src="@/assets/avatar.jpg"></router-link> -->
                    </div>
                    <!-- 简介 -->
...
<script>
    export default {
        ...
        props:{
            src:{
                type: String,
                default: 'https://baseran2.oss-cn-shenzhen.aliyuncs.com/default/style/61594eabab53c_61594eabde6e1.jpg'
            },
            isHome:{
                type: [Boolean,String],
                default: false
            ...
            text:{
                type: String,
                default: "keep on going nerver give up"
            }
        },
        created(){
            // this.getWebSiteInfo()
