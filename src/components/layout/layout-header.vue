<template>
    <div id="layout-header" :class="{'fixed':fixed,'hidden':hidden}" @click.stop="mobileShow=false">
        <div class="site-logo">
            <router-link to="/">
                <img src="@/assets/logo.png" alt="" style="width:40px;height:40px;margin-bottom:10px;">
                <p class="site-name">RanBlogs</p>
            </router-link>
        </div>
        ...
        <div class="site-menus" :class="{'mobileShow':mobileShow}" @click.stop="mobileShow=!mobileShow">
            ...
            <!-- <div class="menu-item"><router-link to="/nav" target="_blank">网址导航</router-link></div>  -->
            <div class="menu-item"><router-link to="/archive" target="_blank">归档</router-link></div> 
            <!-- <div class="menu-item"><router-link to="/friend" target="_blank">友链</router-link></div>  -->
            <div class="menu-item"><router-link to="/about" target="_blank">关于</router-link></div>
        </div>
    </div>
</template>
