        ...
        <div class="site-content">
            <section-title>
                <div class="friend-header">
                    ...
                    <div class="apply"><router-link to="/about#Guestbook" target="_blank">+ 加入</router-link></div>
                </div>
            </section-title>
            <!---说明--->
            <div class="statement">
                <p>首先将需要接入本博客站点，然后给我<router-link to="/about#Guestbook" target="_blank">留言</router-link>提供您站点的如下信息：</p>
                <quote>
                    <p>站点名称：RanBlogs</p>
                    <p>站点链接：https://www.rablogs.com</p>
                    <p>简短描述：...</p>
                </quote>
                <p>接入成功后将会以邮件的方式通知。</p>
            </div>
...
<style scoped lang="less">
    ...
    hr{
        ...
        border: 0;
        height: 1px;
        background-image: linear-gradient(to right, rgba(0, 0, 0, 0), #56ABE0, rgba(0, 0, 0, 0));
    }
    .friend-list{
        width: 100%;
        .friend-item{
